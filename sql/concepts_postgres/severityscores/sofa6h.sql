...
DROP TABLE IF EXISTS sofa6h; CREATE TABLE sofa6h AS 
-- ------------------------------------------------------------------
...
left join vitals_6h v
  on ie.icustay_id = v.icustay_id
left join labs_6h l
  on ie.icustay_id = l.icustay_id
left join urine_output_6h uo
  on ie.icustay_id = uo.icustay_id
left join gcs_6h gcs
...
(
  ...
  , case
    ...
    when  (urineoutput * 4) < 200 then 4
    when (creatinine_max >= 3.5 and creatinine_max < 5.0) then 3
    when  (urineoutput *4) < 500 then 3
