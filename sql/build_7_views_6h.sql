...
-- 1) urine output
\i sql/concepts_postgres/firstday6h/urine_output_first_day.sql

-- 2) vitals
\i sql/concepts_postgres/firstday6h/vitals_first_day.sql

-- 3) gcs
\i sql/concepts_postgres/firstday6h/gcs_first_day.sql

-- 4) labs
\i sql/concepts_postgres/firstday6h/labs_first_day.sql

-- 5) blood gas (dependency first)
\i sql/concepts_postgres/firstday6h/blood_gas_first_day.sql
\i sql/concepts_postgres/firstday6h/blood_gas_first_day_arterial.sql
